...
void emxEnsureCapacity_creal32_T(emxArray_creal32_T *emxArray, int oldNumel)
{
  ...
  if (newNumel > emxArray->allocatedSize) {
    ...
    if (emxArray->data != NULL) {
      memcpy(newData, (void *)emxArray->data, sizeof(creal32_T) * oldNumel);
...
void emxEnsureCapacity_creal32_T1(emxArray_creal32_T *emxArray, int oldNumel)
{
  int newNumel;
  int i;
  void *newData;
...
/* End of code generation (fftfiltering_emxutil.c) */
